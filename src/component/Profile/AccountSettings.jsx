...
import { updateProfile, deleteAccount } from "../State/Authentification/Action";
...
export default function AccountSettings() {
    ...
    const user = useSelector((state) => state.auth.user); // Текущие данные пользователя из Redux
